 ...
 * uno.
 */
static void initialize_neighbor ( tile * &left_a, tile * &right_a,
                                  tile * &under_a, tile * &left_b,
                                  tile * &right_b, tile * &under_b,
 ...
 * @param[in,out] last numero identificativo della prima e dell' ultima tessera.
 */
static void fill_floor( const int &x1, const int &x2, const int &y1,
                        const int &y2, const int &z, int &last       ) ;
